...
def payments(request):
    ...
    # Move cart items to  order produuct table
    ...
    # Send order recieved email to the customer email id
...
def place_order(request, total =0, quantity=0):
    ...
    #if cart is less than or equal to 0, then redurect back to shop
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            # store all the info inside order table
            data= Order()
